...
imgs = torch.load("./data/reconstruct/test/dummy_x_1.pth")
...
show_imgs(dummy_x, x, save=False, dir_path="", filename="")

matplotlib.image.imsave(f"./{batch_size}.png", dummy_x.squeeze().permute([1, 2, 0]).numpy())
...
plt.plot(range(5), class1000_offset, "o-", color="#D95319", markerfacecolor='white', label="FLG*, 1000 class")
plt.plot(range(5), class512_offset, "v--", color="#D95319", label="FLG*, 512 class")
plt.plot(range(5), class256_offset, "x:", color="#D95319", label="FLG*, 256 class")

plt.plot(range(5), class1000, "o-", color="#77AC30", markerfacecolor='white', label="FLG, 1000 class")
plt.plot(range(5), class512, "v--", color="#77AC30", label="FLG, 512 class")
plt.plot(range(5), class256, "x:", color="#77AC30", label="FLG, 256 class")
